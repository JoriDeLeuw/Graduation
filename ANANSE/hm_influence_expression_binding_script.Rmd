...
```{r}
dir <- "/scratch/bacint/jdeleuw/ananse/influence_data2/day0_comp/"
...
```{r}
dir <- "/scratch/bacint/jdeleuw/ananse/influence_data2/reverse_day0_comp/"
...
<!-- Make heatmap for the targeted clusters, showing how the TF in each cluster are being targeted by the other TF in the hm -->
<!-- ```{r} -->
<!-- dir <- '/scratch/bacint/jdeleuw/ananse/binding_data/binding_analysis/' -->
<!-- targeted_paths_list <- c(paste(dir, 'targeted_hm_Cluster1.tsv', sep = ''), -->
<!--                          paste(dir, 'targeted_hm_Cluster2.tsv', sep = ''), -->
<!--                          paste(dir, 'targeted_hm_Cluster3.tsv', sep = ''), -->
<!--                          paste(dir, 'targeted_hm_Cluster4.tsv', sep = ''), -->
<!--                          paste(dir, 'targeted_hm_Cluster5.tsv', sep = ''), -->
<!--                          paste(dir, 'targeted_hm_Cluster6.tsv', sep = '') -->
<!--                          ) -->
<!-- for (i in 1:length(targeted_paths_list)) { -->
...
<!--   path <- targeted_paths_list[i] -->
<!--   color_binding <- colorRamp2(c(0,1,2), brewer.pal(n = 3, 'Greens')) -->
...
<!--               show_row_dend = FALSE, -->
<!--               # row_dend_reorder = TRUE, -->
<!--               column_order = order(as.numeric(gsub("column", "", colnames(numeric_binding_avg)))) -->
<!--               ) -->
<!--          ) -->
<!-- } -->
<!-- ``` -->
...
<!-- TF_binding_avg <- read.csv2('/scratch/bacint/jdeleuw/ananse/binding_data/binding_analysis/avg_binding.tsv',  -->
<!--                           header = TRUE, -->
<!--                           row.names = 1, -->
<!--                           sep = '\t',   -->
<!--                           stringsAsFactors=FALSE)  -->
...
<!-- ```{r} -->
<!-- set.seed(100) -->
<!-- hmlist <- hm_influence + hm_counts + hm_binding -->
<!-- pdf("/scratch/bacint/jdeleuw/ananse/analysis/influence_normCounts_targeted_HM.pdf",width=12,height=12,paper='special', useDingbats=FALSE) -->
<!-- draw(hmlist, -->
