---
title: "avg_comparisons_hm_script"
author: "Jori de Leuw"
date: "May 6, 2021"
...
```{r}
dir <- "/scratch/bacint/jdeleuw/ananse/influence_data2/avg_comp/"

influence_avgvsD0 <- read.csv2(paste(dir, "avgvsday0.txt", sep = ''), 
                   		header = TRUE, 
                    		sep = '\t',  
                    		stringsAsFactors=FALSE)
influence_avgvsD07 <- read.csv2(paste(dir, "avgvsday07.txt", sep = ''), 
                   		header = TRUE, 
                    		sep = '\t',  
                    		stringsAsFactors=FALSE)
influence_avgvsD14 <- read.csv2(paste(dir, "avgvsday14.txt", sep = ''), 
                     		header = TRUE, 
                     		sep = '\t', 
                     		stringsAsFactors=FALSE)
influence_avgvsD21 <- read.csv2(paste(dir, "avgvsday21.txt", sep = ''), 
                      		header = TRUE, 
                      		sep = '\t', 
                      		stringsAsFactors=FALSE)
influence_avgvsD43 <- read.csv2(paste(dir, "avgvsday43.txt", sep = ''), 
                      		header = TRUE, 
                      		sep = '\t', 
                      		stringsAsFactors=FALSE)
influence_avgvsD60 <- read.csv2(paste(dir, "avgvsday60.txt", sep = ''), 
                      		header = TRUE, 
                      		sep = '\t', 
                      		stringsAsFactors=FALSE)
influence_avgvsKC <- read.csv2(paste(dir, "avgvsKC.txt", sep = ''), 
                    		header = TRUE, 
                     		sep = '\t', 
                     		stringsAsFactors=FALSE)
```
...
comparisons <- list(influence_avgvsD0, influence_avgvsD07, influence_avgvsD14, influence_avgvsD21, influence_avgvsD43, influence_avgvsD60, influence_avgvsKC)
...
# pdf("/scratch/bacint/jdeleuw/ananse/analysis/avg_influence_score_HM.pdf",width=12,height=12,paper='special', useDingbats=FALSE)
draw(hm_influence)
# dev.off
```
Load Count_data:
...
# pdf("/scratch/bacint/jdeleuw/ananse/analysis/avg_TPM_HM.pdf",width=12,height=12,paper='special', useDingbats=FALSE)
draw(hm_counts)
# dev.off
```
...
pdf("/scratch/bacint/jdeleuw/ananse/analysis/avg_influence_normCounts_HM.pdf",width=12,height=12,paper='special', useDingbats=FALSE)
draw(hmlist,
     column_title = "Days",
